...
def main():
    ...
    parser = argparse.ArgumentParser(description="AHM Finance Loan Officer Assistant")
    ...
    if args.csv:
        ...
        print("  python inference.py --age 29 --income 32000 --loan_amount 12000 --credit_score 600")
        print("\nFrom CSV file:")
        print("  python inference.py --csv dataset/sample_loan_dataset.csv --row 1")
